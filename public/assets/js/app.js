$(document).ready(function () {
  ...
  // when the remove button is clicked from the saved article list, get the article ID and set its saved property back to false
  ...
  // when the add note button is clicked on the saved articles page, modal is presented with empty form.
  ...
  // delete the note that was clicked and empty the list
